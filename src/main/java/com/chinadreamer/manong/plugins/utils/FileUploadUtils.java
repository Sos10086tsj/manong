...
public class FileUploadUtils {
    ...
    public static final String[] HEADIMAGE_EXTENSION = {
            "bmp", "jpg", "jpeg", "png"
    };
    ...
    public static void setFileRootPath(String fileRootPath) {
        FileUploadUtils.fileRootPath = fileRootPath;
    }
    ...
    public static final String upload(
        ...
        //File desc = getAbsoluteFile(extractUploadDir(request), filename);
            File desc = getAbsoluteFile(FileUploadUtils.fileRootPath,filename);
    ...
    public static final String extractFilename(MultipartFile file, String baseDir, boolean needDatePath)
        ...
        if(needDatePath) {
            filename = baseDir + FileUploadUtils.separator + datePath() + FileUploadUtils.separator + encodingFilename(filename);
        } else {
            filename = baseDir + FileUploadUtils.separator + encodingFilename(filename);//随机文件名
        }
    ...
    private static final String encodingFilename(String filename) {
        ...
        filename = Coder.encryptMD5(filename + System.nanoTime() + counter++) + filename.substring(filename.lastIndexOf("."),filename.length());
        return filename;
    }
    ...
    public static final String saveFile(byte[] b, String fileName) throws IOException{
    	String returnPath = getDefaultBaseDir() + separator + datePath() + separator + encodingFilename(fileName);
    	String filePath = getFileRootPath() + separator + returnPath;
