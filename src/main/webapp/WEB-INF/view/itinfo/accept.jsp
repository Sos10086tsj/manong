...
<body >
			...
			<c:forEach items="${tougaoPage.content }" var="tougao" varStatus="index">
				<tr>
					...
					<td style="text-align:center">
						...
						<a href="javascript:onClick=infoHelp.acceptTougao(${tougao.id})">
							<img class="edit_size" src="../resources/images/accept.png">
						</a>
					</td>
				</tr>
			</c:forEach>
	...
	<manong:page url="/itInfo/accept?pageNum=" componentId="info_accept_page_id" page="${tougaoPage }"></manong:page>
